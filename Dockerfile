...
RUN curl -s --remote-name http://packages.ntop.org/apt/14.04/x64/pfring_7.1.0-1515_amd64.deb
RUN dpkg -i pfring_7.1.0-1515_amd64.deb

RUN curl -s --remote-name http://packages.ntop.org/apt/14.04/x64/ntopng_3.1.171026-3625_amd64.deb
RUN dpkg -i ntopng_3.1.171026-3625_amd64.deb
RUN rm -rf *.deb
